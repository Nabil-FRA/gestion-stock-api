...
/**
 * Auto-generated Migration: Adapted for PostgreSQL with corrected table creation order.
 */
final class Version20250905222103 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create tables for stock management system, adapted for PostgreSQL with corrected order';
    }

    public function up(Schema $schema): void
    {
        // Créer les tables sans dépendances en premier
        ...
        // Créer les tables avec dépendances après
